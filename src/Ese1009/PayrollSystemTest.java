...
public class PayrollSystemTest 
{
   public static void main( String args[] ) 
   {
      ...
      do{
          ...
          meseCorrente = input.nextInt();
      }while((meseCorrente<1) || (meseCorrente >12));
      ...
      for ( Employee currentEmployee : employees ) 
      {
         ...
         if(meseCorrente == currentEmployee.getDataNascita().getMonth())
             System.out.printf("earned $%,.2f + $100.00 bonus compleanno\n\n", currentEmployee.earnings() );
         else
